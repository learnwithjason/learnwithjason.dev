...
<Figure aspectRatio={9 / 16}>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/3X-EUEOg638"
...
Otherwise, you might think devrel means digging into the tech, and the company might think it means writing two blog posts per week. Without [setting clear expectations](https://jason.af/setting-expectations), there could be mismatched goals — and you'll end up leaving the job unhappy.
...
[**A career is a pie-eating contest where the prize for winning is more pie.**](https://jason.af/more-pie)
...
And remember: it will take time. [Keep applying constant, gentle pressure](https://jason.af/constant-gentle-pressure) and you'll get the job. 💜
