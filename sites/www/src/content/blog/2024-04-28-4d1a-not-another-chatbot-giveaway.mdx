...
description: >
  Build an app, learn something new, have some fun, win a prize! Enter by May 10, 2024 to win.
...
import TermsAndConditions from '../../components/terms-and-conditions.astro';
...
5. Submit your web app using the form below

## [Submit your web app](https://forms.gle/4g5uSs87CSri6iVV7)

Entries are submitted via [this Google Form](https://forms.gle/4g5uSs87CSri6iVV7).
