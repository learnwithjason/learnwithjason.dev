...
<Figure caption="<tt>linear-gradient(to right, #de72c6, #2dcde4)</tt>">
  <div style="width: 100%; aspect-ratio: 8 / 1; background: linear-gradient(to right, #de72c6, #2dcde4)"></div>
</Figure>
...
<Figure caption="<tt>linear-gradient(in oklch to right, #de72c6, #2dcde4)</tt>">
  <div style="width: 100%; aspect-ratio: 8 / 1; background: linear-gradient(in oklch to right, #de72c6, #2dcde4)"></div>
</Figure>
