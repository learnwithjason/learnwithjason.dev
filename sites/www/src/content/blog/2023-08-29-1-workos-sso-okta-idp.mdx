...
But things have improved significantly in this space, and tools like WorkOS make adding SSO to a Node app a task that you can fit in before lunch. In this tutorial, we'll add SSO powered by WorkOS, using Okta as an IdP, with TypeScript support and

<Aside>
  Thanks to WorkOS for sponsoring this tutorial. Create a free account and get
  your app ready for enterprise deals at [TKTK workos link].
</Aside>
