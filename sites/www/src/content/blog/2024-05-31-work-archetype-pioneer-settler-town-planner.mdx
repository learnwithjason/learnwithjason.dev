---
slug: work-archetype-pioneer-settler-town-planner
pubDate: 2024-05-31

title: >
  Understand your work archetype: pioneers, settlers, and town planners
description: >
  What kind of work is the best fit FOR YOU? A quick assessment to help you optimize for a job that you'll actually enjoy.

share:
  image: https://res.cloudinary.com/jlengstorf/image/upload/f_auto,q_auto/v1717274478/lwj/blog/job-archetype-pioneers-settlers-city-planners.jpg
---
...
<Figure>
  ![a three-panel composite image with a covered wagon on a rural landscape in the left panel, a construction site with a house framed with wood in the center, and a complicated network of pipes and valves on the right](https://res.cloudinary.com/jlengstorf/image/upload/f_auto,q_auto/v1717274478/lwj/blog/job-archetype-pioneers-settlers-city-planners.jpg)
</Figure>

Simon Wardley describes ["pioneers, settlers, and town planners"](https://blog.gardeviance.org/search?q=PST) as the three core archetypes that make a company function.

<Aside>
  **NOTE:** In my videos, I've frequently used a variation of these names: "pioneers, town settlers, and city planners". I didn't do this intentionally; I just had the names crossed up in my mind.
</Aside>
...
## Pioneers thrive in the unknown

The pioneer archetype is at their best when they have a problem to solve and very little structure around how to solve it. Pioneers are comfortable with ambiguity and excited to try something new — in fact, they're often bored by things that _aren't_ new.

### Pioneers thrive when:
...
### Pioneers will struggle with:

- Highly structured environments
- Prescriptive direction (dictating _how_ to do things)

## Settlers turn promise into product

The settler archetype shines in roles where there's strong evidence that an idea will work, if only someone would sit down and do the work properly. Settlers find satisfaction in turning potential into reality, combining customer feedback and iterative testing to smooth out the rough edges and build something commercially viable.

### Settlers thrive when:
