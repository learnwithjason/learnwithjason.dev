...
meta:
  ...
  description: >
    If you're a developer who focuses on data & APIs and doesn't want to touch the design or CSS of a site, Wix might be exactly what you need. Hear me out.
...
It turns out Wix actually has a huge librarby of developer APIs available that let us handle the backend of our client sites while letting our clients continue managing their site's look and feel in a visual, no-code interface.

<Aside style="heart">
  Disclosure: Wix sponsored this tutorial, but they don't have any control over
  what I built or what I say about the tools.
</Aside>

## What does Wix offer developers?

When I started looking through the developer-focused tools Wix offers, two things caught my eye:
...
## Enable the Wix developer tools

To get started with coding, click the curly bois (`{}`) in the left-hand nav and click the "Start Coding" button.

<Figure caption="The first time you use the code tools, Wix asks for an opt in.">
...
<Figure caption="The “Code in Wix IDE” link is at the top of the code pane.">
  ![the code tab in Wix with a link to "Code in Wix IDE" shown at the top of the
