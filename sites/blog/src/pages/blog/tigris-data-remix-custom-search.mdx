...
The scope of building all of this can feel pretty daunting. Tigris Data is out to make faceted search much less difficult to implement, and in this video we'll walk through how you can build your own directory app using Tigris Data and Remix.

In this tutorial, you’ll learn how to implement a full-featured search functionality using Remix and Tigris Data.

<Aside>
  Huge thanks to [Tigris Data](https://www.tigrisdata.com/) for sponsoring this
  tutorial. They’re working on a great solution for apps that have
  directory-like data, like e-commerce stores, product catalogs, and other big
  data sets that would benefit from being filterable and searchable.
</Aside>
