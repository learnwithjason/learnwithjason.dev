...
share:
  title: Type-safe, data-driven apps, even if databases freak you out
  text: You can build a DB-powered app with end-to-end type safety AND real-time updates without needing to learn how to manage databases. A full tutorial.
---
...
<Figure aspectRatio={9 / 16}>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/_oZt0NuCqh8"
