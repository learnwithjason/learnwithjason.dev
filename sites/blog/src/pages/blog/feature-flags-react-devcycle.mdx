...
<Figure aspectRatio={9 / 16}>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/i6j2hT7ox0c"
...
Thanks again to DevCycle for sponsoring this video. Learn more about what you can do with DevCycle on their website, and make sure to watch this video next for even more learning.
