...
excerpt: >
  A step-by-step video tutorial on setting up a local WordPress development
  environment in minutes using Trellis, plus how to deploy FAST with free SSL.
...
<Image caption="The local instance of our WordPress site.">

  ![](./images/learn-roots-wordpress-01.jpg)
...
<Image caption="The WordPress dashboard after logging in.">

  ![](./images/learn-roots-wordpress-02.jpg)
...
<Image caption="The DNS record that points the subdomain to the Digital Ocean droplet.">

  ![](./images/learn-roots-wordpress-03.jpg)
...
<Image caption="After deploying, the live site is accessible.">

  ![](./images/learn-roots-wordpress-04.jpg)
...
<Image caption="The WP Sync DB plugin on the live site.">

  ![](./images/learn-roots-wordpress-05.jpg)
...
<Image caption="Settings for the WP Sync DB plugin on the development site.">

  ![](./images/learn-roots-wordpress-06.jpg)
...
<Image caption="WP Sync DB in progress.">

  ![](./images/learn-roots-wordpress-07.jpg)

</Image>

<Image caption="WP Sync DB after a successful sync.">

  ![](./images/learn-roots-wordpress-08.jpg)
