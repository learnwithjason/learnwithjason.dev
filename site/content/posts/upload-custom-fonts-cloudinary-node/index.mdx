...
Unfortunately, the web UI for Cloudinary doesn't seem to work for uploading custom fonts. This script will allow you to upload an OTF or TTF to use when adding text overlays to images.

**IMPORTANT:** make sure you have the appropriate licenses to upload the fonts.
