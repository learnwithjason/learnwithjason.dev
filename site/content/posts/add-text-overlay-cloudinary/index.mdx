...
<Aside>
  ...
  **Heads up!** Cloudinary supports several fonts by default — there’s no list available, so you’ll have to just try a font out and see if it works. If the font you’d like to use isn’t available by default, you can [upload custom fonts for use with Cloudinary text overlays](/blog/upload-custom-fonts-cloudinary-node/) as well.
...
- [using a custom font for Cloudinary text overlays](/blog/upload-custom-font-cloudinary-node/)
- [creating custom social media cards automatically using text overlays](/blog/auto-generate-social-image/)
- reading the [Cloudinary docs on text overlays](https://cloudinary.com/documentation/image_transformations#adding_text_captions)
