...
If you want to use custom fonts with [Cloudinary](https://cloudinary.com/), you need to upload them as authenticated assets.

While you can [use Cloudinary Node SDK to upload custom fonts](/blog/upload-custom-font-cloudinary-node/) (or one of the [other SDKs](https://cloudinary.com/documentation)), it's sometime more convenient to use the [Media Library UI](https://cloudinary.com/console/media_library) to drag and drop fonts. However, it's not immediately clear *how* to upload fonts as authenticated assets.
