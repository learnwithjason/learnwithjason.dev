...
title: Bundle Stylesheets and Add LiveReload With Rollup
excerpt: >
...
<Video youtubeID="hJ2RVXEIgkk" playlist="PLz8Iz-Fnk_eRM5oTjUdn2CQ7lPf-zmhVD" />
...
- [Part I: How to Use Rollup to Process and Bundle JavaScript Files](/code/learn-rollup-js/)
- [Part II: How to Use Rollup to Process and Bundle Stylesheets](/code/learn-rollup-css/) <— you are here
...
<Image caption="The stylesheet is processed by PostCSS and injected by Rollup.">
...
<Image caption="With the watcher running, changes trigger a rebuild. The linter catches errors right away. Neat, huh?">
...
<Image caption="File changes trigger a browser reload.">
...
<Image caption="LiveReload + automatic rebundling feels like magic.">
