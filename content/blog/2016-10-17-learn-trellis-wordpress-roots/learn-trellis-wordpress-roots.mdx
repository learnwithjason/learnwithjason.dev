export const meta = {
  date: '2016-10-17',
  title: 'Automatic WordPress Deployment + Free SSL: Trellis How-To',
  description:
  ...
  image: 'images/learn-trellis-roots-wordpress.jpg',
  tags: ['wordpress', 'php', 'devops'],
  share: {
...
<Figure aspectRatio={315 / 560}>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube-nocookie.com/embed/Ls30HGKru8A"
    frameborder="0"
