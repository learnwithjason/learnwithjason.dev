export const meta = {
  ...
  tags: ['front-end', 'javascript', 'reduce', 'forms', 'ajax'],
};
...
<Figure aspectRatio={646 / 1000}>
  <iframe
    height="1000"
    width="646"
    title="[UPDATED] How to Get Form Field Data as JSON Using Plain JavaScript"
    src="https://codepen.io/jlengstorf/embed/preview/rNMpJNy?height=1000&theme-id=light&default-tab=result"
    frameborder="no"
    loading="lazy"
  ...
  >
    See the Pen{' '}
    <a href="https://codepen.io/jlengstorf/pen/rNMpJNy">
      [UPDATED] How to Get Form Field Data as JSON Using Plain JavaScript
    </a>{' '}
    by Jason Lengstorf (<a href="https://codepen.io/jlengstorf">@jlengstorf</a>)
